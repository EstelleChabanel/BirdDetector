...
from yolo.nn.tasks import DetectionModel, DomainClassifier, MultiDomainClassifier
...
class MultiDomainClassifierTrainer(BaseTrainer):
    """
    A class extending the BaseTrainer class for training based on a detection model.
    ...
    def get_validator(self):
        """Returns a DetectionValidator for YOLO model validation."""
        self.loss_names = 'box_loss', 'cls_loss', 'dfl_loss', 'da_loss_1', 'da_loss_2', 'da_loss_3'
        return yolo.detect.DomainClassifierValidator(self.test_loader, save_dir=self.save_dir, args=copy(self.args))
