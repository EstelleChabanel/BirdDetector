...
DATASETS = {'source': ['global-bird-zenodo_pfeifer', 'global-bird-zenodo_penguins', 'global-bird-zenodo_poland'],
            'target': ['global-bird-zenodo_palmyra'] #, 'global-bird-zenodo_mckellar']
}
...
if not os.path.exists(SAVING_FOLDER):
    os.makedirs(os.path.join(SAVING_FOLDER, "train", "source", "images"))
    os.makedirs(os.path.join(SAVING_FOLDER, "train", "source", "labels"))
    os.makedirs(os.path.join(SAVING_FOLDER, "train", "target", "images"))
    os.makedirs(os.path.join(SAVING_FOLDER, "train", "target", "labels"))
    os.makedirs(os.path.join(SAVING_FOLDER, "val", "source", "images"))
    os.makedirs(os.path.join(SAVING_FOLDER, "val", "source", "labels"))
    os.makedirs(os.path.join(SAVING_FOLDER, "val", "target", "images"))
    os.makedirs(os.path.join(SAVING_FOLDER, "val", "target", "labels"))
    os.makedirs(os.path.join(SAVING_FOLDER, "test", "source", "images"))
    os.makedirs(os.path.join(SAVING_FOLDER, "test", "source", "labels"))
    os.makedirs(os.path.join(SAVING_FOLDER, "test", "target", "images"))
    os.makedirs(os.path.join(SAVING_FOLDER, "test", "target", "labels"))
...
for domain in DATASETS:
    ...
    for dataset in DATASETS[domain]:
        ...
        data_temp["Test"] = save_split_portion("test/"+domain, test_img, dataset_folder, SAVING_FOLDER, dataset_config)
        data_temp["Val"] = save_split_portion("val/"+domain, val_img, dataset_folder, SAVING_FOLDER, dataset_config)
        data_temp["Train"] = save_split_portion("train/"+domain, train_img, dataset_folder, SAVING_FOLDER, dataset_config)
