...
SAVING_FOLDER = r'/gpfs/gibbs/project/jetz/eec42/data/pfpepo_10percentbkgd'
...
DATABASE1_SOURCE = ['global-bird-zenodo_poland', 'global-bird-zenodo_penguins', 'global-bird-zenodo_pfeifer']
