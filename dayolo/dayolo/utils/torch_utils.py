...
from dayolo.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, __version__
from dayolo.utils.checks import check_version
...
def strip_optimizer(f: Union[str, Path] = 'best.pt', s: str = '') -> None:
    ...
    Example:
        ```python
        from pathlib import Path
        from dayolo.utils.torch_utils import strip_optimizer
...
def profile(input, ops, n=10, device=None):
    ...
    Example:
        ```python
        from dayolo.utils.torch_utils import profile
