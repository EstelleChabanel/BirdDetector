...
TASKS = 'detect', 'deepcoral_detect', 'segment', 'classify', 'pose'
TASK2DATA = {'detect': 'coco8.yaml', 'deepcoral_detect': 'coco8.yaml', 'segment': 'coco8-seg.yaml', 'classify': 'imagenet10', 'pose': 'coco8-pose.yaml'}
TASK2MODEL = {
    'detect': 'yolov8n.pt',
    'deepcoral_detect': 'yolov8n.pt',
    'segment': 'yolov8n-seg.pt',
    'classify': 'yolov8n-cls.pt',
    'pose': 'yolov8n-pose.pt'}
TASK2METRIC = {
    'detect': 'metrics/mAP50-95(B)',
    'deepcoral_detect': 'metrics/mAP50-95(B)',
